...
function LabCountsCard({
  labNumber,
  reportedDevicesCount,
  workingDevicesCount,
  capacity,
}) {
  return (
    <div>
      <div className="counts-card">
        ...
        <div className="bottom-part">
          ...
          <span className="working-devices-count">
            <TbDeviceImacCheck className="react-icons-working" />
            {workingDevicesCount}
          </span>
          <span className="reported-devices-count">
            <TbDeviceImacX className="react-icons-reported" />{" "}
            {reportedDevicesCount}
          </span>
        </div>
      </div>
